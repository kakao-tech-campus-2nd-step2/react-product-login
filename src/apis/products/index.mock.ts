...
export const fetchProductDetailHandlers = [
  rest.get(`${process.env.REACT_APP_BASE_URL}/api/products/:productId`, (_, res, ctx) =>
    res(ctx.json(PRODUCTS_MOCK_DATA.content[0])),
  ),
];
