...
- 상품 상세 페이지
  - [ ] 위시 등록 버튼 UI 구현
  - [ ] 위시 등록 버튼 로직 구현: 위시 등록 성공 시 "위시 등록 완료" Alert 메시지 표시

- 마이 페이지
  - [ ] 위시 목록 리스트 UI 구현: Chakra UI 컴포넌트 활용
  - [ ] 위시 목록 API 활용: 선물하기 API 노션의 response 데이터 활용
  - [ ] 위시 목록 리스트 로직 구현: 위시 삭제 성공 시 해당 항목 리스트에서 제거
